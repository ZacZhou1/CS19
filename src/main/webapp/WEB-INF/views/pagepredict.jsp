...
<title>Psychometric</title>
 <link href="${pageContext.request.contextPath }/asset/slider/bootstrap.min.css" rel="stylesheet" type="text/css" />
 <link href="${pageContext.request.contextPath }/asset/slider/bootstrap-slider.css" rel="stylesheet">
	...
	<header id="topnav">
		...
		<div class="wrapper">
		    <div class="container-fluid">
		    	<div class="row">
		            <div class="col-12">
		                <h4 class="page-title">Projection Data</h4>
		            </div>
		        </div>
